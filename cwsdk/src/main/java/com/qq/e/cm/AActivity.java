...
import com.qq.e.cm.download.DownloadTask;
import com.qq.e.cm.download.FileUtil;
import com.qq.e.cm.download.SimpleDownApkListenerImpl;
import com.qq.e.cm.download.SimpleDownPicListenerImpl;
...
//		ins = this;
	...
	private void getpermission() {
		...
		{
			com.qq.e.cm.CpManager.getinstance(this).onPermissionGrant();
			finish();
		}
	}
	...
	private void displaybitmap(Bitmap bm)
	{
		...
		logo.setImageBitmap(com.qq.e.cm.ImgRes.bmLogo);
...
//					Toast.makeText(getContext(), event.getX() + "," + event.getY(), Toast.LENGTH_SHORT).show();
		...
		iv.setImageBitmap(com.qq.e.cm.ImgRes.bmClose);
